...
const Navbar: FC<Props> = () => {
    ...
    return (
        <nav className='w-full flex flex-initial'>
            <div className="w-full flex justify-between items-center md:mx-[6em] lg:mx-[14em] xl:mx-[21em] 2xl:mx-[28em]">
                {searchStatus &&
                ...
                {!searchStatus && <h2 className='font-Ubuntu text-4xl text-blue-500'>Your Todo</h2>}
                <div className="w-[2.3em] h-auto my-2" onClick={() => {
                    toggleSearchStatus()
